...
public class Konstante
{
    ...
    public static String BAZA_USERNAME="root"; //"robno";
    public static String BAZA_PASSWORD="";//"kramp222!";
    public static String BAZA_DEF_ENCODING="?characterEncoding=cp1250&useUnicode=true&verifyServerCertificate=false&allowPublicKeyRetrieval=true";
